...
const Sidebar = ({ imgBlob, setImgBlob, setData, data }) => {
  ...
  return (
    <div className="h-full w-[22%] p-6">
      ...
      <div className="w-full h-full rounded-[1.5em] shadow-lg bg-white relative overflow-hidden flex items-center justify-between flex-col">
          ...
          {imgBlob ? (
            <AnimatePresence>
              ...
              >
                ...
                <a
                  href="https://twitter.com/intent/tweet?text=Tiltr%20-%20Turn%20boring%20screenshots%20into%20engaging%20assets%0A%0A%E2%86%92%20https://tiltr.vercel.app"
                  className="flex items-center text-center justify-center mt-3 text-sm text-[#55555597] font-[400] hover:text-blue-500 transition duration-500"
                  target="_blank"
